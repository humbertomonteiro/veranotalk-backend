...
const sendEmail_utils_1 = require("../../utils/sendEmail.utils"); // Importar a função de email
const logger_1 = __importDefault(require("../../utils/logger")); // Importar logger para melhor tracking
class CreateManualCheckoutUseCase {
    ...
    async execute(input) {
        ...
        try {
            ...
            const totalAmount = this.calculateTotalAmount(input.checkout.fullTickets, input.checkout.halfTickets || 0);
...
//# sourceMappingURL=CreateCheckoutManual.usecase.js.map